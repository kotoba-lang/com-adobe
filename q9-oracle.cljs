(ns q9-oracle
  "The Clojure side of the whole-component acceptance: run `adobe-compat.main` under
   ...
   result."
  (:require [adobe-compat.main :as m]
...
(println "; oracle = adobe-compat.main under nbb")
